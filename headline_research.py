...
try:
    ...
    print(f"Successfully imported {len(headline_pairs)} headline pairs")
except ImportError:
    print("headline_pairs.py not found. Using sample data instead.")
    # If headline_pairs.py doesn't exist, try to load from JSON file
    try:
...
def plot_engagement_results(results):
    ...
    if headline_ids:
        ...
        feature_names = ["flesch_reading_ease", "flesch_kincaid_grade", "complex_word_percentage", "avg_word_length", "word_count"]
        feature_labels = ["Reading Ease", "Grade Level", "Complex Words %", "Avg Word Length", "Word Count"]
